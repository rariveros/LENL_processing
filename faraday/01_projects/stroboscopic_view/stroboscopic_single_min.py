...
if __name__ == '__main__':
    ...
    i_max, j_max = np.unravel_index(big_initial_window.argmin(), big_initial_window.shape)
    ...
    while i_max < Nt - 5 * period_fps:
        ...
        i_max_new, j_max_new = np.unravel_index(window.argmin(), window.shape)
        ...
        if n % 10 == 0:
            ...
            j_max_Z = np.unravel_index(big_window.argmin(), big_window.shape)[0]
            print(j_max_Z)
